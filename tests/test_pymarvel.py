...
def test_run_marvel(transfile, test_nqn, segmentfile):
    from pymarvel.pymarvel import run_marvel
...
def test_generate_marvel_energies(transfile, test_qn_list, segmentfile):
    from pymarvel.pymarvel import generate_marvel_energies

    df_energies = generate_marvel_energies(transitions_file=transfile, qn_list=test_qn_list, segment_file=segmentfile)
